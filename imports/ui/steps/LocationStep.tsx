...
const getLatLong = getOr({}, 'response.view.0.result.0.location.displayPosition')
        ...
        <div className={"text-center mx-auto"} style={{ maxWidth: "70%"}}>
            ...
            <div className={""}>
               ...
               <div className={"mt-3 flex mx-auto"} style={{ maxWidth: "180px" }}>
                   <div className={"w-1/2"}>
                       <Button color={!hasFoundLocation ? "green-500" : "gray-400"} onClick={() => {
                   ...
                   <div className={"w-1/2"}>
                       <Button color={hasFoundLocation ? "green-500" : "gray-400"}
                               onClick={() => props.nextPage()}>{hasFoundLocation ? "Continue" : "Skip"}</Button>
                   </div>
               </div>
            </div>
        </div>
